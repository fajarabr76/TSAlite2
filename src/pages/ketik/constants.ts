...
export const AI_MODELS = [
  { id: 'gemini-3.1-flash-lite-preview', name: 'Gemini 3.1 Flash Lite', description: 'Cepat dan ringan untuk percakapan dasar.' },
...
export const TEMPLATE_GREETING = "Selamat pagi/siang/sore Bapak/Ibu. Terima kasih telah menghubungi Contact Center OJK. Ada yang bisa kami bantu?";
