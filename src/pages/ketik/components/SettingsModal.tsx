...
import { Clock, Trash2, X, Plus, Check, Edit2, RotateCcw, Save, Image as ImageIcon, User, Settings, FileText, Users } from 'lucide-react';
  ...
  return (
    <div className="fixed inset-0 bg-black/40 backdrop-blur-md z-50 flex items-center justify-center p-4">
      ...
      >
              ...
              {!isScenarioFormOpen ? (
                ...
                <div id="scenario-form" className="bg-white dark:bg-[#1C1C1E] rounded-2xl border border-gray-200 dark:border-white/10 shadow-lg overflow-hidden">
                    ...
                    <div className="p-6 grid grid-cols-2 gap-5">
                        ...
                        <div className="col-span-2">
                             <label className="block text-xs font-bold text-gray-500 dark:text-gray-400 uppercase mb-2">Skrip Percakapan (Opsional)</label>
                             <textarea className="w-full rounded-xl border-gray-200 dark:border-white/10 bg-gray-50 dark:bg-[#2C2C2E] p-3 text-sm text-gray-900 dark:text-white focus:ring-2 focus:ring-blue-500 outline-none resize-none" rows={3} value={newScenarioScript} onChange={(e) => setNewScenarioScript(e.target.value)} />
                        </div>
                        <div className="col-span-2">
                              ...
                              <div className="flex gap-3 mt-4 overflow-x-auto pb-2">
                                {newScenarioImages.map((img, idx) => (
                                  <div key={idx} className="relative w-20 h-20 shrink-0 group">
                                    <img src={img} className="w-full h-full object-cover rounded-xl border border-gray-200 dark:border-white/10"/>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  >
                      <div className="flex justify-between items-start">
                          ...
                          {localSettings.activeConsumerTypeId === 'random' && <div className="w-6 h-6 bg-blue-500 rounded-full flex items-center justify-center"><Check className="w-3.5 h-3.5 text-white" /></div>}
                      </div>
                      <p className="text-sm text-gray-500 dark:text-gray-400 mt-2">
                          Sistem akan memilih salah satu karakter secara acak setiap kali sesi dimulai.
                      </p>
                  </div>
             ...
             <div className="space-y-6">
                <div className="bg-white dark:bg-[#1C1C1E] p-6 rounded-2xl border border-gray-200 dark:border-white/10 shadow-sm">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                       ...
                       <p className="text-sm text-gray-500 dark:text-gray-400 mt-1 leading-relaxed">
                           Konfigurasi nama konsumen dan nama agen untuk salam pembuka.
                       </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="p-8 rounded-[2.5rem] border border-gray-200 dark:border-white/10 bg-white dark:bg-[#1C1C1E] shadow-sm">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        ...
                        <div className="col-span-1">
                            <label className="block text-xs font-bold text-gray-500 dark:text-gray-400 uppercase mb-3 ml-1">Nama Agen (Untuk Salam Pembuka)</label>
                            <input type="text" className="w-full rounded-2xl border-gray-200 dark:border-white/10 bg-gray-50 dark:bg-[#2C2C2E] p-4 text-base text-gray-900 dark:text-white focus:ring-2 focus:ring-blue-500 outline-none transition-all" placeholder="Contoh: Fajar" value={localSettings.identitySettings?.signatureName || ''} onChange={(e) => handleIdentityChange('signatureName', e.target.value)} />
                        </div>
                        <div className="col-span-1">
                 ...
                 <section className="space-y-4">
                    <div className="bg-white dark:bg-[#1C1C1E] p-6 rounded-2xl border border-gray-200 dark:border-white/10 shadow-sm">
                      <div className="flex items-start gap-4">
                        ...
                        <div>
                           <h3 className="font-bold text-gray-900 dark:text-white text-lg">Pilih Model AI</h3>
                           <p className="text-sm text-gray-500 dark:text-gray-400 mt-1 leading-relaxed">
        ...
        {/* Modal Footer */}
        <div className="p-6 border-t border-gray-200/50 dark:border-white/5 flex justify-between gap-4 bg-white/80 dark:bg-[#1C1C1E]/80 backdrop-blur-xl shrink-0">
          <button
              onClick={handleResetDefaults}
              className="px-6 py-3 text-red-500 text-sm font-bold hover:bg-red-50 dark:hover:bg-red-500/10 rounded-2xl transition-all flex items-center gap-2"
          >
          ...
          <div className="flex gap-3">
              <button 
                onClick={handleClose} 
                className="px-8 py-3 bg-gray-100 dark:bg-[#2C2C2E] text-gray-700 dark:text-gray-300 rounded-2xl hover:bg-gray-200 dark:hover:bg-[#3A3A3C] font-bold transition-all"
              >
                Tutup
              </button>
              <button 
                onClick={handleSave} 
                className="px-10 py-3 bg-blue-500 hover:bg-blue-600 text-white rounded-2xl font-bold shadow-lg shadow-blue-500/20 transition-all flex items-center gap-2"
              >
