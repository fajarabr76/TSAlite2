...
import { Clock, Trash2, X, Plus, Check, Edit2, User, Settings, FileText, Users, Image as ImageIcon } from 'lucide-react';
      ...
      >
        ...
        <div className="px-8 py-6 border-b border-gray-200/50 dark:border-white/5 flex justify-between items-center bg-white/50 dark:bg-[#1C1C1E]/50 backdrop-blur-xl shrink-0">
          ...
          <div className="flex items-center gap-3">
            <button 
                onClick={handleSave}
                className="px-6 py-2 bg-blue-500 hover:bg-blue-600 text-white rounded-full font-bold shadow-lg shadow-blue-500/20 transition-all flex items-center gap-2"
            >
